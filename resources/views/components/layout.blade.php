...
<body class="h-full">
    <div class="min-h-full">
            ...
            <div class="px-4 sm:px-4 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <p class="text-base font-medium text-white">Dulces Momentos</p>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6">
                            <button type="button"
                                ...
                                <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white"
                                ...
                                <div>
                                    <button type="button" class="relative flex max-w-xs items-center"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="white" class="size-8">
                                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <header class="bg-white shadow">
            <div class="mx-auto px-4 py-6 sm:px-4 lg:px-8">
                {{ $heading }}
            </div>
        </header>
        <main>
